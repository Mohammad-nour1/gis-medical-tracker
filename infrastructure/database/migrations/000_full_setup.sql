...
VALUES
  ...
  ('22222222-2222-2222-2222-222222222204', 'AMB-LTK-04', 'available', ST_SetSRID(ST_MakePoint(35.7985, 35.5318), 4326)::geography),
  ...
  ('22222222-2222-2222-2222-222222222208', 'AMB-TRS-08', 'available', ST_SetSRID(ST_MakePoint(35.8985, 34.8910), 4326)::geography),
